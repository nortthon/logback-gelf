...
class CustomX509TrustManager implements X509TrustManager {
    ...
    CustomX509TrustManager(final X509TrustManager defaultTrustManager, final String hostname,
        ...
        this.defaultTrustManager = Objects.requireNonNull(defaultTrustManager);
    ...
    public void checkServerTrusted(final X509Certificate[] chain, final String authType)
        ...
        final boolean explicitlyTrustedCertificate = trustedServerCertificates.contains(serverCert);

        if (explicitlyTrustedCertificate) {
